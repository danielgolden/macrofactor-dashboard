...
// Client-component modules are also evaluated on the server during
// SSR/prerender, where these relative-URL fetches would always fail, so the
// prefetches only run in the browser.
